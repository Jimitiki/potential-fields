...
f.add_field(fields.linear_repulsive_field(fields.fixed_position_tracker(r_field1[0], r_field1[1]), 800, 3))
f.add_field(fields.linear_repulsive_field(fields.fixed_position_tracker(r_field2[0], r_field2[1]), 1000, 3))
f.add_field(fields.linear_repulsive_field(fields.fixed_position_tracker(r_field3[0], r_field3[1]), 1200, 4))
f.add_field(fields.linear_repulsive_field(fields.fixed_position_tracker(r_field4[0], r_field4[1]), 1400, 4))
yes = 1
while yes > 0:
    ...
    if "center" in res:
        ...
        yes = robot.follow_vector2(vector[0], vector[1], goal)
